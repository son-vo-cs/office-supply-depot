                            ...
                            <div>
                                <table className="table">
                                    ...
                                    <tr>
                                        ...
                                        <th className="text-center itemColRemove">Remove All</th>
                                    </tr>
                                    </thead>
                                    ...
                                    {this.state.itemList.map((item, idx) => (
                                        <tr key={item.itemid}>
                                            ...
                                            <td className="cell">
                                                <input type="number" min ="1" className="form-control input-sm inline-block" id={item.itemid} 
                                                defaultValue={item.quantityInCart} onChange={() => this.editShoppingCart(item.itemid, idx)}/>
